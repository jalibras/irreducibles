# this is a simple (and very rough around the edges) 
# home made database system to keep track of the 
# collections of graphs and oriented rotation systems that arise 
# during the inductive search for irreducibles.
